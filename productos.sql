...
VALUES (
        18,
        'Tenis Lifestyle Negro-Marrón Levi\'s Carson',
        172900,
        '33',
        'Americano',
        'levis-2219-0859062-1-zoom.webp',
        'Agotado'
    ),
    (
        19,
        'Tenis Lifestyle Blanco-Gris Royal County of Berksh',
        172900,
        '33',
        'Americano',
        'royal-county-of-berkshire-polo-club-8222-6232262-1-zoom.webp',
        'Nuevo'
    ),
    (
        20,
        'Tenis Lifestyle Azul Navy-Amarillo-Blanco adidas S',
        177900,
        '38',
        'Nacional',
        'adidas-performance-4411-0541162-1-zoom.webp',
        'En Promocion'
    ),
    (
        21,
        'Tenis de Niño marca Hot wheels / Tenis xia 6-24-2 ',
        129000,
        '27',
        'De niño',
    ...
    (
        22,
        'Tenis Lifestyle Negro-Blanco-Beige adidas Sportswe',
        184000,
        '33, 35, 30',
        'Americano',
        'adidas-performance-4235-4459262-1-zoom.webp',
        'Nuevo'
    );
...
VALUES (
        4,
        'Camista Oversize unisex manga corta',
        70000,
        'XL, M, S',
        'Negro',
        'Americana',
        'Nuevo',
        'camiseta-oversize-unicolor-con-manga-corta.webp',
        'Hombre'
    ),
    (
        5,
        'Camiseta unicolor oversize con manga corta y hombro rodado',
        70000,
        'XL, M, S',
        'Base',
        'Americana',
        'En Promocion',
        'camiseta-unicolor-oversize-con-manga-corta-y-hombro-rodado.jpg',
        'Hombre'
    ),
    (
        6,
        'Camiseta oversize roja con diseño college y cuello V',
        70000,
        'XL, M, 2XL, S',
        'Rojo',
        'Nacional',
...
VALUES (
        2,
        'Gafas de Sol Dorado Ray-Ban Frank',
        400000,
        'ray-ban-8064-2781752-1-zoom.webp',
        'Nuevo'
    ),
    (
        3,
        'Gafas Negras Oakley',
        539000,
        'oakley-2477-1280501-1-zoom.webp',
        'En Promocion'
    ),
    (
        4,
        'Gafas de Sol Azul-Plaetado Ray-Ban Erika',
        100000,
        'ray-ban-8079-4781752-1-zoom.webp',
        'Agotado'
    );
...
VALUES (
        4,
        'Formas Intimas Pantalón Sudadera Mujer Verde FI 8618',
        31200,
        '33, 34',
        'Verde',
        'Nacional',
        'Nuevo',
        'formas-intimas-2574-9316052-1-catalog-new.webp',
        'Mujer'
    ),
    (
        5,
        ...
        'Americano',
        'En Promocion',
        'outfit-colombia-9990-4621842-3-zoom.webp',
        'Hombre'
    ),
    (
        6,
        'Atypical Pantalón Atypical 33440',
        73500,
        '33, 32, 22',
        'Negro',
        'Nacional',
        'Agotado',
        'atypical-8302-1749442-1-zoom.webp',
        'Unisex'
    );
...
VALUES (
        2,
        'Perfume Voyage De Nautica Para Hombre 100 Ml',
        104900,
        'Original',
        'nautica-6236-6300761-1-zoom.webp',
        'Nuevo'
    ),
    (
        7,
        'Perfume Original Bade\'e Al Oud Amethyst 100 ML',
        172900,
        'Original',
        'lattafa-7613-4890462-1-zoom.webp',
        'En Promocion'
    ),
    (
        8,
        'Perfume 1.0 Delilah Pour Femme EDP 100 ML',
        80000,
        '1.0',
        'lattafa-7618-3890462-1-zoom.webp',
        'Agotado'
    );
...
VALUES (
        2,
        'Reloj Mulco Mujer Mw-3-17290-021',
        979300,
        'mulco-6198-3265001-1-zoom.webp',
        'Nuevo'
    ),
    (
        3,
        'Reloj Casio Mujer GMA-S120GB-1ADR',
        563500,
        'casio-5565-1657402-1-zoom.webp',
        'En Promocion'
    ),
    (
        4,
        'Reloj Para Hombre Invicta Pro Diver 30018 Plateado',
        289900,
        'invicta-9078-5403401-1-zoom.webp',
        'Agotado'
    );
...
--
ALTER TABLE `calzado` ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `camisas`
--
ALTER TABLE `camisas` ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `gafas`
--
ALTER TABLE `gafas` ADD PRIMARY KEY (`ID`);

--
-- Indices de la tabla `pantalones`
--
ALTER TABLE `pantalones` ADD PRIMARY KEY (`ID`);
...
--
ALTER TABLE `relojes` ADD PRIMARY KEY (`ID`);

    ...
    fetch("api.php?tabla=pantalones")
        ...
        .then((data) => {
            ...
            data.forEach((pantalon) => {
                ...
                div.innerHTML = `<div class="portfolio_single_content">
                                    <img src="./imagenes/Pantalones/${pantalon.Imagen}" width="20px" height="500px" alt="${pantalon.NombrePantalon}" />
                                    <div>
    ...
    fetch("api.php?tabla=relojes")
        ...
        .then((data) => {
            ...
            data.forEach((reloj) => {
                ...
                div.innerHTML = `<div class="portfolio_single_content">
                                    <img src="./imagenes/relojes/${reloj.Imagen}" width="20px" height="500px" alt="${reloj.MarcaReloj}" />
                                    <div>
    ...
    fetch("api.php?tabla=gafas")
        ...
        .then((data) => {
            ...
            data.forEach((gafas) => {
                ...
                div.innerHTML = `<div class="portfolio_single_content">
                                    <img src="./imagenes/Gafas/${gafas.Imagen}" width="20px" height="500px" alt="${gafas.MarcaGafas}" />
                                    <div>
    ...
    fetch("api.php?tabla=perfumes")
        ...
        .then((data) => {
            ...
            data.forEach((perfume) => {
                ...
                div.innerHTML = `<div class="portfolio_single_content">
                                    <img src="./imagenes/perfumes/${perfume.Imagen}" width="20px" height="500px" alt="${perfume.NombrePerfume}" />
                                    <div>
